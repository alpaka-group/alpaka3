...
Each output pixel is written exactly once, so no atomics are needed.
  ...
  .. literalinclude:: ../../snippets/example/210_miniProject.cpp
    :language: cpp
...
- :doc:`../advanced/performance` for what to optimize first if the image becomes large
...
.. raw:: html
   ...
   <summary>210_miniProject.cpp</summary>

.. filteredliteralinclude:: ../../snippets/example/210_miniProject.cpp
   :language: cpp
   :linenos:
