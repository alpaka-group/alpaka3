...
namespace alpaka::onHost::tune::internal::core
{
    /**
    ...
    private:
        ...
        [[nodiscard]] auto selectNextConfig(uint32_t numAttempts = 0)
        {
            ...
            auto ctx = alpaka::onHost::tune::StrategyContext<
                decltype(this->env_tuningModel),
                decltype(this->env_metricInterface)>{view, this->getHistory(), this->env_environmentState};
...
#define allowPrematureConfigSkip 0
        ...
        void update(tune::config::ConfigRecord<T_Config>& stored, double_t const& metric)
        {
