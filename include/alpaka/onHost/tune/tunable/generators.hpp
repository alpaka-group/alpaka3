 ...
 */
namespace alpaka::onHost::tune::generate
{
    /**
    ...
    struct LinSpace
    {
        ...
        {
            return internal::generateSequence(start, end, step, [](auto& val, auto& step) { val += step; });
        }
    };
    ...
    struct LogSpace
    {
        ...
        std::vector<T> operator()() const
        {
            return internal::generateSequence(start, end, base, [](auto& val, auto& step) { val *= step; });
        }
    };
