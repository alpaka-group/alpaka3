...
namespace alpaka::onHost::tune
{
    ...
    /**
 * @namespace alpaka::onHost::tune::metricInterface
 ...
 *     void start() { begin measurement  }
    ...
    *@endcode* **/
    namespace metricInterface
    {
        ...
        struct Timing
        {
            static constexpr internal::returnComparison returnComparison{internal::returnComparison::LowerIsBetter};
        ...
        struct Occupancy
        {
            static constexpr internal::returnComparison returnComparison{internal::returnComparison::HigherIsBetter};
    ...
    static auto const& compareGetBest(auto const& a, auto const& b)
        requires(T_Metric::returnComparison == internal::returnComparison::HigherIsBetter)
    {
        if(a > b)
            return a;
        return b;
    ...
    template<typename T_Metric>
    static auto const& compareGetBest(auto const& a, auto const& b)
        requires(T_Metric::returnComparison == internal::returnComparison::LowerIsBetter)
    {
        if(a < b)
            return a;
        return b;
