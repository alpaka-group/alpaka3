...
#include <alpaka/tune/config/kruskalCompare.hpp>
...
namespace alpaka::tune::config
{
    ...
    void prematureConfigSkip(
        ...
        alpaka::tune::core::peripherals::EnvironmentState<T_Config>& state)
    {
        ...
        double_t const& metric)
    {
        ...
        if((stored.nr_runs >= alpaka::tune::Vars::getRunsPerConfig()))
        {
