...
namespace alpaka::tune
{
    ...
    public:
        ...
        constexpr auto withNumFramesTune(Args... tunableArgs) && requires(!std::is_void_v<detail::GetTunableTypeFromParameterPack<Args...>>)
        {
            using T = detail::GetTunableTypeFromParameterPack<Args...>;
            auto tune = alpaka::tune::NumFramesTune{std::forward<Args>(tunableArgs)...};
         ...
         */
        template<typename... Args>
        constexpr auto withFrameExtentTune(Args&&... tunableArgs) && requires(!std::is_void_v<detail::GetTunableTypeFromParameterPack<Args...>>)
        {
            using T = detail::GetTunableTypeFromParameterPack<Args...>;
            auto tune = alpaka::tune::FrameExtentTune{std::forward<Args>(tunableArgs)...};
         ...
         */
        template<typename... Args>
        constexpr auto withNumBlocksTune(Args&&... tunableArgs) && requires(!std::is_void_v<detail::GetTunableTypeFromParameterPack<Args...>>)
        {
            using T = detail::GetTunableTypeFromParameterPack<Args...>;
            auto tune = alpaka::tune::NumBlocksTune{std::forward<Args>(tunableArgs)...};
         ...
         */
        template<typename... Args>
        constexpr auto withNumThreadsTune(Args&&... tunableArgs) && requires(!std::is_void_v<detail::GetTunableTypeFromParameterPack<Args...>>)
        {
            using T = detail::GetTunableTypeFromParameterPack<Args...>;
            auto tune = alpaka::tune::NumThreadsTune{std::forward<Args>(tunableArgs)...};
