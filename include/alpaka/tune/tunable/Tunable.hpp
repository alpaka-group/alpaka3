...
namespace alpaka::tune
{
    ...
    template<class... Args>
    NumFramesTune(Args...) -> NumFramesTune<tune::frame::numFrames, detail::GetTunableTypeFromParameterPack<Args...>>;
    ...
    FrameExtentTune(Args...)
        -> FrameExtentTune<tune::frame::frameExtent, detail::GetTunableTypeFromParameterPack<Args...>>;
    ...
    template<class... Args>
    NumBlocksTune(Args...) -> NumBlocksTune<tune::frame::numBlocks, detail::GetTunableTypeFromParameterPack<Args...>>;
    ...
    template<class... Args>
    NumThreadsTune(Args...)
        -> NumThreadsTune<tune::frame::numThreads, detail::GetTunableTypeFromParameterPack<Args...>>;
